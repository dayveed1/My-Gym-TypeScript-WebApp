...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    ...
    className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
        ...
        <motion.div className="md:flex mx-auto w-5/6 items-enter justify-center md:h-5/6"
            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                >
                    ...
                    <p className="mt-8 text-sm">
                        Unrivaled Gym. Unparalleled Training Fitness Classes. World Class Studio to get the Body Shapes That you Dream Of.
