...
const benefits: Array<BenefitType> = [{
    ...
    description: "Nemo Judias Incassasua in the begningin was the world and the world was GOD so let sleeping dogs lie",
},
{
  ...
  return (
    ...
    className="mx-auto min-h-full w-5/6 py-20">
        ...
        onViewportEnter={() =>  setSelectedPage(SelectedPage.Benefits)}>
          ...
          <div className=" md:flex mt-16 item-center justify-between gap-20 md:mt-28">
            {/* Image */}
            <img
             className="mx-auto" alt="benefits-page-graphic"
